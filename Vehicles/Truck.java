...
public class Truck {
    ...
    public Truck(String lic, int yr, Color cl, String mk, int cap) {
    ...
    public void setLoadCapacity(int cap) {
        if (cap <= 0) {
            throw new IllegalArgumentException("It must have some capacity.");
        }
        loadCapacity = cap;
    }
    ...
    public int hashCode() {
        ...
        sum += loadCapacity; // Adds loadcapacity
